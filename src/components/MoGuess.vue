...
import type { GuessItem } from '@/types/hot'
import type { PageParams } from '@/types/global'
import type { Ref } from 'vue'
//分页参数
const pageParams: Ref<Required<PageParams>> = ref({
  page: 1,
  pageSize: 10,
})
...
//获取猜你喜欢数据接口
const getHomeGuessLikeAPIData = async () => {
...
//暴露方法
defineExpose({
  getMore: getHomeGuessLikeAPIData,
  resetDate,
})
</script>
...
<template>
  ...
  <view class="loading-text"> {{ finish ? '没有了' : '正在加载... ' }}</view>
</template>
