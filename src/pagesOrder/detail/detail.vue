...
import { getMemberOrderAPI, getMemberOrderByIdAPI } from '@/services/order'
import type { OrderResult } from '@/types/order'
import { OrderState, orderStateList } from '@/services/constants'
import { getPayWxPayMiniPayAPI, getPayMockAPI, getMemberOrderCancelByIdAPI } from '@/services/pay'
// 获取屏幕边界到安全区域距离
...
<template>
  ...
  <scroll-view scroll-y class="viewport" id="scroller" @scrolltolower="onScrolltolwer">
    <template v-if="order">
      <!-- 订单状态 -->
      <view class="overview" :style="{ paddingTop: safeAreaInsets!.top + 20 + 'px' }">
        ...
        <template v-if="order?.orderState === OrderState.DaiFuKuan">
          ...
          <view class="tips">
            ...
            <uni-countdown :second="order.countdown" :show-day="false" @timeup="onTimeup" />
          </view>
  ...
  <uni-popup ref="popup" type="bottom" background-color="#fff">
    <view class="popup-root">
      ...
      <view class="footer">
        ...
        <view class="button primary" @tap="onDelOrder()">确认</view>
      </view>
    </view>
  </uni-popup>
</template>
