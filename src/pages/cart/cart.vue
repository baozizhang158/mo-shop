...
const gotoPayment = () => {
  ...
  } else uni.navigateTo({ url: '/pagesOrder/create/create' })
}
</script>
  ...
  <scroll-view scroll-y class="scroll-view">
    ...
    <template v-if="memberStore.profile">
          ...
          <uni-swipe-action-item v-for="item in cartList" :key="item.skuId" class="cart-swipe">
            ...
            <view class="goods">
              ...
              >
                ...
                <view class="meta">
                  <view class="name ellipsis">{{ item.attrsText }}</view>
                  <view class="attrsText ellipsis">{{ item.name }}</view>
      ...
      <view class="toolbar">
        ...
        <text class="amount">{{ selectedCartListPrice }}</text>
